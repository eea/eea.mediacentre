...
# from eea.mediacentre.bbb import fileimage_file
# from eea.mediacentre.bbb.fileimage_image import ImageURLWidget
# # from p4a.fileimage.image._widget import ImageURLWidget
#
# from zope.i18nmessageid import MessageFactory
# _ = MessageFactory('eea.mediacentre')
#
# class MediaPlayerWidget(fileimage_file.FileDownloadWidget):
...
#                                % mime_type))
#
#         s = u'<div class="media-player">%s</div>' % media_player(absolute_url,
